...
export default function PaymentNotificationPage() {
  ...
  return (
    <main className="min-h-screen bg-white flex flex-col items-center">
      ...
      {/* Printable Content — flex column so footer can stick to bottom */}
      <section
        ref={contentRef}
        className="bg-white w-full max-w-3xl pt-6 px-4 text-sm text-black leading-relaxed print:shadow-none print:max-w-none flex flex-col min-h-[297mm]"
      >
        ...
        <img
          ...
          className="mx-auto mb-4 block pb-12 h-[13rem] mr-[1rem] w-auto object-contain bg-white"
        />
        ...
        <div className="mt-4 space-y-4 text-sm text-black text-justify">
          <p>
            Our client has requested First National Bank Limited to send this
        ...
        <p className="mt-auto text-xs pt-6 text-black">
          <strong>First National Bank</strong> A division of FirstRand Bank Limited. An
